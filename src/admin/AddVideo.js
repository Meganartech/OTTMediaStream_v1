...
const AddVideo = () => {
  ...
  const save = async (e) => {
    ...
    console.log(audioData)
    const Addvideo = { title: Movie_name, tags: TagId, description: Description,categoryId: categoryId,certificateId: certificateId,LanguageId: LanguageId,Duration:Duration,Year:Year,thumbnail:thumbnail};
